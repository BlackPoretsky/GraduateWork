 ...
 *
 * Определяет способ активации способности.
 */
UENUM(BlueprintType)
 ...
 *
 * Определяет, как способность активируется по отношению к другим способностям.
 */
UENUM(BlueprintType)
...
/** Причина сбоя, которая может быть использована для воспроизведения анимационного монтажа при возникновении сбоя */
 ...
 *
 * Базовый класс способностей используемый в проекте.
 */
...
public:
    ...
    /**Возвращает значение true, если запрошенная группа активации является допустимым переходом. */
    ...
    /** Пытается изменить группу активации. Возвращает значение true, если она была успешно изменена. */
    UFUNCTION(BlueprintCallable, BlueprintPure = false, Category = "After|Ability", Meta = (ExpandBoolAsExecs = "ReturnValue"))
...
protected:
    ...
    /** Вызывается, когда способность предоставляется AbilitySystemComponent */
    UFUNCTION(BlueprintImplementableEvent, Category = Ability, DisplayName = "OnAbilityAdded")
    void K2_OnAbilityAdded();

    /** Вызывается, когда способность удаляется из AbilitySystemComponent */
    UFUNCTION(BlueprintImplementableEvent, Category = Ability, DisplayName = "OnAbilityRemoved")
    void K2_OnAbilityRemoved();

    /** Вызывается, когда способность инициализируется с помощью аватара пешки. */
