...
namespace AfterGameplayTags
{
    ...
    UE_DEFINE_GAMEPLAY_TAG_COMMENT(InputTag_Select, "InputTag.Select", "Select input.");
    UE_DEFINE_GAMEPLAY_TAG_COMMENT(InputTag_Drop, "InputTag.Drop", "Drop input.");
    UE_DEFINE_GAMEPLAY_TAG_COMMENT(InputTag_Weapon_Reload, "InputTag.Reload", "Reload input");
    UE_DEFINE_GAMEPLAY_TAG_COMMENT(InputTag_Weapon_Fire, "InputTag.Fire", "Fire input");
    ...
    FGameplayTag FindTagByString(const FString& TagString, bool bMatchPartialString)
    {
        ...
        if (!Tag.IsValid() && bMatchPartialString)
        {
            ...
            for (const FGameplayTag& TestTag : AllTags)
            {
                ...
                {
                    UE_LOG(LogAfter, Display, TEXT("Could not find exact match for tag [%s] but found partial match on tag [%s]."),
